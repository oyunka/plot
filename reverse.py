...
def Legendre1():
    ...
    for j in range(0, num_kang):
        all +=   first[j]  * weight[j] * cos_ang[j]
...
def Legendre2():
    ...
    for j in range(0, num_kang):
        all +=   first[j]  * weight[j] * 0.5 * (3*(cos_ang[j])**2 - 1)
...
def Legendre3():
    ...
    for j in range(0, num_kang):
        all +=   first[j]  * weight[j] * 0.5 * (5* pow(cos_ang[j], 3) - 3 * cos_ang[j])
...
def Legendre4():
    ...
    for j in range(0, num_kang):
        all +=   first[j]  * weight[j] * 1/8 * (35 * pow(cos_ang[j], 4) - 30 * pow (cos_ang[j], 2) + 3)
